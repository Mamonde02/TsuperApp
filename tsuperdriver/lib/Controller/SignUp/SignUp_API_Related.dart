...
extension extAPIRelated on _SignUpVC {
  ...
  void registerTsuper() async {
    ...
    print("Creating new data inside are: ${fnameTxtController.text}, ${lnameTxtController.text}, ${phoneNumTxtController.text}, ${emailTxtController.text}, ${pwd}, ${selectedMemberType}");

    // print("Creting new data inside are: $fnameTxtController, $lnameTxtController, $phoneNumTxtController, $emailTxtController, $pwdTxtController, $selectedMemberType");
