...
class StyledToastPosition1 {
  ...
  const StyledToastPosition1({this.align = Alignment.center, this.offset = 0.0});

  /// Center position.
  static const center =
      StyledToastPosition1(align: Alignment.center, offset: 0.0);

  /// Top center position.
  static const top =
      StyledToastPosition1(align: Alignment.topCenter, offset: 10.0);

  /// Bottom center position.
  static const bottom =
      StyledToastPosition1(align: Alignment.bottomCenter, offset: 20.0);

  /// Center left position.
  static const left =
      StyledToastPosition1(align: Alignment.centerLeft, offset: 17.0);

  /// Center right position.
  static const right =
      StyledToastPosition1(align: Alignment.centerRight, offset: 17.0);
}
